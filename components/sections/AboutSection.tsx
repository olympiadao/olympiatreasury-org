...
const flowSteps = [
  ...
  { icon: FileCheck, title: "Proposals Submitted", desc: "Any address can submit an OFP naming recipient, amount, and metadata. Submission is permissionless, gated only by the Governor's proposal threshold." },
